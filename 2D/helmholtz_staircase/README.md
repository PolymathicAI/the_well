...
**Associated paper**: Fruzsina J. Agocs, Alex H. Barnett, Trapped acoustic waves and raindrops: high-order accurate integral equation method for localized excitation of a periodic staircase, 2024.

**Domain scientist**: Fruzsina Julia Agocs, Center for Computational Mathematics, Flatiron Institute, Simons Foundation.

**Code or software used to generate the data**: https://www.github.com/fruzsinaagocs/bies [DOUBLE CHECK WEBSITE]
...
analytic in this case: $U(t, \mathbf{x}) = u(\mathbf{x})e^{-i\omega t}.$ Therefore
any spatial solution may serve as an initial condition.
...
Hardware used to generate the data and precision used for generating the data: 64 CPU cores.
