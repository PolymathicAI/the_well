...
@pytest.mark.skipif(WELL_BASE_PATH is None, reason="WELL_BASE_PATH not set")
def test_create_mini_well():
    ...
    try:
        ...
        for dataset_name in datasets_to_test:
            ...
            # Basic assertions
            assert len(mini_dataset.files_paths) == 1
            ...
            assert mini_metadata.spatial_resolution == expected_resolution
            assert len(mini_dataset) < len(original_dataset)
