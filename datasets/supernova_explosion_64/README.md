...
**Code or software used to generate the data**: ASURA-FDPS (Smoothed Particle Hydrodynamics) [[Github](https://github.com/FDPS/FDPS)]
...
![Gif](gif/temperature_normalized.gif)
