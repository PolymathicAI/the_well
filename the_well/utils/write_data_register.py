    ...
    for root_dir in root_dirs:
        ...
        for root, dirs, files in os.walk(root_dir):
            for file in files:
                ...
                file_list.append(os.path.join(root, file).replace('/mnt/home/polymathic/ceph/the_well/', base_url))
...
if __name__ == '__main__':
    ...
    directories_to_index = ['/mnt/home/polymathic/ceph/the_well/2D/active_matter/data', 
