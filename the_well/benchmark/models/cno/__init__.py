"""
Copied from https://github.com/bogdanraonic3/ConvolutionalNeuralOperator/blob/main/CNOModule.py
"""
...
#         self.in_factor = in_size
#         self.out_factor = out_size
...
#         x = F.interpolate(x, scale_factor=2, mode = self.interp_type,  antialias = True)
#         x = self.act(x)
#         # print('post_act', x.shape)
#         # if out_size_override is not None:
#         x = F.interpolate(x, size = self.out_factor, mode=self.interp_type, antialias = True)
#         # else:
