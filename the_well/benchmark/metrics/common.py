...
def metric(f):
    ...
    def metric_wrapper(*args, **kwargs):
        ...
        assert x.ndim >= spatial_ndims + 1, 'x must have at least spatial_ndims + 1 dimensions'
        assert y.ndim >= spatial_ndims + 1, 'y must have at least spatial_ndims + 1 dimensions'
